...
class PalestrasDetalhes extends StatelessWidget {
  final Palestras palestras;
  final bool cadastro;
  const PalestrasDetalhes({Key key, this.palestras, this.cadastro = true})
      : super(key: key);
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    palestras.obs != null && palestras.obs != ''
                        ? ListTile(
                      dense: true,
                      title: Text(
                        "Observação",
                      ...
                      title: FlatButton(
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            ...
                            http.post(Uri.parse(
                                baseUrl +
                                    "palestras/${palestras.id}/cadastrar"),
                                body: {
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "minicursos/${palestras.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
