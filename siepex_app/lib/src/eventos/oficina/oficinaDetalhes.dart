...
class OficinaDetalhes extends StatelessWidget {
  final Oficina oficina;
  final bool cadastro;
  const OficinaDetalhes({Key key, this.oficina, this.cadastro = true})
      : super(key: key);
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "oficina/${oficina.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
