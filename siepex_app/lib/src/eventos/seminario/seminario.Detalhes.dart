...
class SeminarioDetalhes extends StatelessWidget {
  final Seminario seminario;
  final bool cadastro;
  const SeminarioDetalhes({Key key, this.seminario, this.cadastro = true})
      : super(key: key);
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    ListTile(
                      ...
                      subtitle: Text(
                        "${seminario.hr_inicio}-${seminario.hr_fim}",
                        style: TextStyle(fontSize: 15),
                      ),
                    ),
                    Divider(
                    ...
                    ListTile(
                      ...
                      /*subtitle: Text(
                        "Sala ${oficina.sala} no prédio ${oficina.local}",
                        style: TextStyle(fontSize: 15),
                      ),*/
                    ),
                    Divider(
                    ...
                    seminario.obs != null && seminario.obs != ''
                        ? ListTile(
                      dense: true,
                      title: Text(
                        "Observação",
                      ...
                      title: FlatButton(
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            ...
                            http.post(Uri.parse(
                                baseUrl +
                                    "seminario/${seminario.id}/cadastrar"),
                                body: {
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "seminario/${seminario.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
