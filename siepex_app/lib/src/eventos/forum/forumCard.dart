...
import 'package:siepex/src/eventos/forum/forumDetalhes.dart';

class ForumCard extends StatelessWidget {
  final Forum forum;
  final bool cadastro;
  const ForumCard({Key key, this.forum, this.cadastro = true})
      : super(key: key);
