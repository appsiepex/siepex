...
class ForumDetalhes extends StatelessWidget {
  final Forum forum;
  final bool cadastro;
  const ForumDetalhes({Key key, this.forum, this.cadastro = true})
      : super(key: key);
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "forum/${forum.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
