...
class MusicaDetalhes extends StatelessWidget {
  final Musica musica;
  final bool cadastro;
  const MusicaDetalhes({Key key, this.musica, this.cadastro = true})
      : super(key: key);
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "musica/${musica.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
