...
class DancaDetalhes extends StatelessWidget {
  final Danca danca;
  final bool cadastro;
  const DancaDetalhes({Key key, this.danca, this.cadastro = true})
      : super(key: key);
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "danca/${danca.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
