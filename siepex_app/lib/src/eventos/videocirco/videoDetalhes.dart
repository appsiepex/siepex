...
class VideoDetalhes extends StatelessWidget {
  final Video video;
  final bool cadastro;
  const VideoDetalhes({Key key, this.video, this.cadastro = true})
      : super(key: key);
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "video/${video.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
