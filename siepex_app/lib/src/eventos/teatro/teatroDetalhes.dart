...
class TeatroDetalhes extends StatelessWidget {
  final Teatro teatro;
  final bool cadastro;
  const TeatroDetalhes({Key key, this.teatro, this.cadastro = true})
      : super(key: key);
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "teatro/${teatro.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
