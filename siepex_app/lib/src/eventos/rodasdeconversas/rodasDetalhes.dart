...
class RodasDetalhes extends StatelessWidget {
  final Rodas rodas;
  final bool cadastro;
  const RodasDetalhes({Key key, this.rodas, this.cadastro = true})
      : super(key: key);
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "rodas/${rodas.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
