...
class MostraDetalhes extends StatelessWidget {
  final Mostra mostra;
  final bool cadastro;
  const MostraDetalhes({Key key, this.mostra, this.cadastro = true})
      : super(key: key);
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "mostra/${mostra.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
