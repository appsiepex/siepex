...
class CircoDetalhes extends StatelessWidget {
  final Circo circo;
  final bool cadastro;
  const CircoDetalhes({Key key, this.circo, this.cadastro = true})
      : super(key: key);
                        ...
                        onPressed: () {
                          Participante.getStorage().then((participante) {
                            http
                                ...
                                "circo/${circo.id}/liberar/${participante.id}"))
                                .then((respostaRaw) {
                              var resposta = jsonDecode(respostaRaw.body);
                              if (resposta['status'] == "sucesso") {
                                Alert(
